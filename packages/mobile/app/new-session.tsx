          ...
          headerRight: () => (
            ...
            >
              {creating ? (
                ...
                <Text style={styles.createHeaderBtn}>Create</Text>
              )}
            </TouchableOpacity>
          ),
        }}
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.modelGrid}>
          {MODELS_BY_AGENT[agentType].map((m) => (
            <TouchableOpacity
              key={m}
              style={[styles.modelChip, model === m && styles.modelChipSelected]}
              onPress={() => setModel(m)}
              activeOpacity={0.75}
            >
              <Text style={[styles.modelChipText, model === m && styles.modelChipTextSelected]}>
                {m}
              </Text>
            </TouchableOpacity>
          ))}
...
const styles = StyleSheet.create({
  ...
  modelChipSelected: { backgroundColor: colors.accentDim, borderColor: colors.accent },
  ...
  createHeaderBtn: { color: colors.accent, fontFamily: "SpaceMono", fontSize: 14, fontWeight: "700" },
});
